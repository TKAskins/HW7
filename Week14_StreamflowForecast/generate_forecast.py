...
if args.model == 'longterm_avg':
    ...
    trend_model = fit_trend_model(recent)
    print("\n--- Step 3: Generate 5-day trend forecast ---")
    forecast_df = make_5day_forecast_trend(trend_model, start_date=args.forecast_date)
    model_label = 'Trend'
