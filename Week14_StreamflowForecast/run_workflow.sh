...
FORECAST_DATE="2026-03-30"   # First day of the 5-day forecast (YYYY-MM-DD)
REFIT_MODEL="False"           # True = re-fit from scratch | False = use saved_model.pkl
RUN_VALIDATION="True"        # True = show validation plots and metrics
MODEL="trend"         # longterm_avg = training mean, monthly_avg = mean for each calendar month
